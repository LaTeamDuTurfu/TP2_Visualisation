...
class StockAPI:
    def __init__(self):
        ...
        self.API_KEYS = [self.API_KEY0, self.API_KEY1, self.API_KEY2, self.API_KEY3, self.API_KEY4, self.API_KEY5, self.API_KEY6, self.API_KEY7, self.API_KEY8, self.API_KEY9]

        self.current_api_key_num = 0
    ...
    def recherche_stock(self, keyword):
        ...
        while True:
            ...
            if reponse.status_code == 200:
                ...
                print(f"Key #{self.current_api_key_num}: Code {reponse.status_code} - {reponse.reason}\n")
                if self.current_api_key_num + 1 <= len(self.API_KEYS):
                    self.current_api_key_num += 1
                    print(f"Trying with Key #{self.current_api_key_num}")
